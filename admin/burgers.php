...
<br>
    <div class="container-fluid">
            ...
            <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nieuw</a>
					</h6>
				</div>
          ...
          if(isset($_SESSION['success'])){
            ...
            unset($_SESSION['success']);
					...
					<div class="table-responsive">
						...
						$query = "SELECT IDnummer, Achternaam, Voornaam, GeboorteDatum, GeboortePlaats, Geslacht, district.DistrictNaam as District FROM burgers, district WHERE burgers.DistrictID = district.ID";
                  ...
                  <th>District</th>
                      ...
                      <td> <?php echo $row['District']; ?> </td>
                          ...
                          <button type="submit" name="edit_btn" class="btn btn-success"><i class="fa fa-edit"></i> Wijzigen</button>
											...
											<td>
                        <form action="voters_delete.php" method="post">
                          <input type="hidden" name="delete_id" value="<?php echo $row['IDnummer']; ?>">
