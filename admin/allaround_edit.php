        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            if (isset($_POST['edit_btn'])) {
              $id = $_POST['edit_id'];
              $query = "SELECT * FROM burgers WHERE IDnummer='$id'";
              $query_run = mysqli_query($conn, $query);

              foreach ($query_run as $row) {
            ?>

                <form action="voters_edit.php" method="POST">
                  <input type="hidden" name="edit_id" value="<?php echo $row['IDnummer'] ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="edit_gebdat" value="<?php echo $row['GeboorteDatum'] ?>" class="form-control" placeholder="GeboorteDatum">
                  </div>
                  <div class="form-group">
                    <label>GeboortePlaats</label>
                    <input type="text" name="edit_gebplaats" value="<?php echo $row['GeboortePlaats'] ?>" class="form-control" placeholder="GeboortePlaats">
                  </div>
                  <div class="form-group">
                    <label>Geslacht</label>
                    <input type="text" name="edit_geslacht" value="<?php echo $row['Geslacht'] ?>" class="form-control" placeholder="Geslacht">
                  </div>
                  <div class="form-group">
                  ...
                  <a href="burgers.php" class="btn btn-danger">CANCEL</a>
